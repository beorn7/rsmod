...
class TestBase(unittest.TestCase):
    ...
    def testCostOfOwnership(self):
        ...
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, -1, "training"), -1)
        ...
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 5, "full"), 0)
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 6, "training"), 0)
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 6, "short"), 0)
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 6, "full"), 0)
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 7, "training"), 0)
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 7, "short"), 0)
        self.assertEqual(base.CostOfOwnership({1,19,20,43,45,100}, 7, "full"), 0)
